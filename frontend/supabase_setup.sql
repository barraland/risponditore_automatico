...
-- Numeri amministratore (possono lasciare promemoria via voce), editabili da dashboard.
...
declare t text;
begin
  foreach t in array array['locali','agenti','contatti','ordini','righe_ordine','azienda','documenti','sezioni','testi_categoria','ticket','messaggi_chat','chiamate_voce','risposte_ticket','promemoria'] loop

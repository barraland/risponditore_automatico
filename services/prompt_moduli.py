...
DEFAULT_MODULI = [
    ...
    },
    {
        ...
        "testo": (
            ...
            "giorni_validita (0 = senza scadenza). Passa SEMPRE anche tenant={{tenant}} e "
            "telefono = il NUMERO del chiamante, cioè ESATTAMENTE il valore di {{telefono_chiamante}} "
            "(solo cifre): NON scrivere mai «amministratore» né altre etichette nel campo telefono.\n"
